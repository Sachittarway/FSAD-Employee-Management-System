...
const EmployeeList = () => {
  ...
  const handleViewDetails = (employeeId) => {
    navigate("/UserDetails", { state: { employeeId } });
  };
  ...
  const fetchEmployeeListByDepartment = async (departmentId) => {
    try {
      ...
      if (!response.ok) {
        console.error(
          "Failed to fetch employee list by department. Status:",
          response.status
        );
        return;
      }
  ...
  const fetchEmployeeListByRole = async (role) => {
    try {
      ...
      if (!response.ok) {
        console.error(
          "Failed to fetch employee list by role. Status:",
          response.status
        );
        return;
      }
  ...
  const fetchEmployeeListByLocation = async (countryName) => {
    try {
      ...
      if (!response.ok) {
        console.error(
          "Failed to fetch employee list by location. Status:",
          response.status
        );
        return;
      }
